  ...
  mainPanel(
    tabsetPanel(id = "my_tabs", 
      ...
      tabPanel(title = "Individual data", value = "tab_indiv", 
               htmlOutput("table_individual_title"),
               htmlOutput("table_individual_filters"),
        DT::dataTableOutput("table_individual_penguins")),
      # tab_sum ----
      tabPanel(title = "Summary data", value = "tab_sum", 
               htmlOutput("table_sum_title"),
               htmlOutput("table_sum_filters"),
        DT::dataTableOutput("table_sum_penguins")),
      # tab_bar ----
